            ...
            >
                ...
                <div className='row d-flex justify-content-center ar-content'>
                    <div className='row col-md-12 ar-nav'>
                        <button className='col-md-3'>Dịch vụ chờ làm</button>
                        <button className='col-md-3'>Dịch vụ đã hoàn thành</button>
                        <button className='col-md-3'>Dịch vụ định kỳ</button>
                    </div>
